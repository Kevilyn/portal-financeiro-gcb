    ...
    <>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          {activeTab === 'abrir' && (
            <div className="bg-gradient-to-br from-[#0066CC] to-blue-800 text-white rounded-2xl shadow-xl overflow-hidden p-8 md:p-12 relative">
              <div className="relative z-10 max-w-2xl">
                ...
                <Button 
                  ...
                  className="bg-white text-[#0066CC] hover:bg-gray-100 font-bold text-lg px-8 py-6 h-auto"
                >
                  Abrir conta grátis <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
                <p className="text-xs text-blue-200 mt-4 font-medium">*Sujeito à análise de crédito</p>
              </div>
...
export default DashboardCasasBahia;