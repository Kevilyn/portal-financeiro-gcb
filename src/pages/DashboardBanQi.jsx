    ...
    <>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          {activeTab === 'abrir' && (
            <div className="bg-gradient-to-br from-[#FFD700] to-yellow-600 text-gray-900 rounded-2xl shadow-xl overflow-hidden p-8 md:p-12 relative">
              <div className="relative z-10 max-w-2xl">
                ...
                <ul className="space-y-4 mb-8">
                  {[
                    ...
                    <li key={idx} className="flex items-center gap-3">
                      <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center text-[#FFD700]">
                ...
                <Button 
                  ...
                  className="bg-gray-900 hover:bg-gray-800 text-white font-bold text-lg px-8 py-6 h-auto"
                >
                  Abrir conta grátis <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
                <p className="text-xs text-gray-800 mt-4 font-medium">*Sujeito à análise de crédito</p>
              </div>
